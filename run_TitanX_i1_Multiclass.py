...
num_classes = 1 # keep this at one, because the ground truth label is not using one hot encoding. Prepare the data accordingly and using gray scale to encode class instead. Pretty much nothing else here needs to be modified.
size_step = 8
size_epoch = 5000

train_data_path = Path(r"C:\Git\MarkerTrainer\data_multiclass\augmentation_2019-09-17T01_21_43.765359")  # this folder MUST contain a LABEL folder and a TRAIN folder of flat images WITH IDENTICAL NAME-label pair.
